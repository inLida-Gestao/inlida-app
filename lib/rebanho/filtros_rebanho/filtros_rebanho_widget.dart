                                  ...
                                  Expanded(
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        ...
                                        if (datePicked != null) {
                                          FFAppState().filtroDataNascimentoInicio = datePicked;
                                          safeSetState(() {});
                                        }
                                      },
                                      child: Container(
                                              ...
                                              Text(
                                                ...
                                                style: FlutterFlowTheme.of(context)
                                                    ...
                                                    .override(
                                                      ...
                                                      color: FFAppState().filtroDataNascimentoInicio != null
                                  ...
                                  Expanded(
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        ...
                                        if (datePicked != null) {
                                          FFAppState().filtroDataNascimentoFim = datePicked;
                                          safeSetState(() {});
                                        }
                                      },
                                      child: Container(
                                            ...
                                            children: [
                                              Text(
                                                ...
                                                style: FlutterFlowTheme.of(context)
                                                    ...
                                                    .override(
                                                      fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                      color: FFAppState().filtroDataNascimentoFim != null
                                                          ? FlutterFlowTheme.of(context).secondaryText
                                                          : const Color(0xFF9E9E9E),
                                                      fontSize: 16.0,
                                                      letterSpacing: 0.0,
