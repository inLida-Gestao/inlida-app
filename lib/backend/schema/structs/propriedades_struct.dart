...
class PropriedadesStruct extends BaseStruct {
  PropriedadesStruct({
    int? id,
    String? createdAt,
    String? userID,
  ...
  static PropriedadesStruct fromMap(Map<String, dynamic> data) =>
      PropriedadesStruct(
  ...
  static PropriedadesStruct? maybeFromMap(dynamic data) => data is Map
      ? PropriedadesStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static PropriedadesStruct fromSerializableMap(Map<String, dynamic> data) =>
      PropriedadesStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'PropriedadesStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is PropriedadesStruct &&
        id == other.id &&
...
PropriedadesStruct createPropriedadesStruct({
  int? id,
  String? createdAt,
  String? userID,
  String? usersID,
