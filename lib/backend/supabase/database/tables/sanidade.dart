...
class SanidadeRow extends SupabaseDataRow {
  ...
  String? get protocoloD0 => getField<String>('protocolo_d0');
  set protocoloD0(String? value) => setField<String>('protocolo_d0', value);

  String? get protocoloRetirada => getField<String>('protocolo_retirada');
  set protocoloRetirada(String? value) =>
      setField<String>('protocolo_retirada', value);

  String? get protocoloIatf => getField<String>('protocolo_iatf');
  set protocoloIatf(String? value) => setField<String>('protocolo_iatf', value);
}
